...
const Main = () => (
  <section className="main">
    ...
    <About
      sectionStyles="about"
      title="Acerca de mi"
      paragraph1="Hola! mi nombre es Miguel y tengo gran afinidad hacía el trabajo colaborativo,
      ...
      considero que un buen producto no solo brinda una solución sino que permite crear una
       experiencia emocional en las personas que lo usan."
      paragraph2="En mi proceso creativo utilizo
